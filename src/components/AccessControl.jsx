...
export default function AccessControl({ user, currentPage, onPageChange, children }) {
  ...
  // Restrict prospect-stats to only operation roles
  const isProspectStatsRestricted = currentPage === 'prospect-stats' && 
    role !== 'operation' && 
    role !== 'operations' && 
    role !== 'ops' &&
    role !== 'admin';
  
  if (isSalesPageRestricted || isOperationDashboardRestricted || isPricingRestricted || isProspectStatsRestricted) {
    ...
    } else if (isProspectStatsRestricted) {
      descriptionText = "This page is only accessible to Operations users. Please contact your administrator if you believe you should have access.";
      alertTitle = "Login as Operations Required";
      alertText = "To access this page, please log in with Operations credentials.";
