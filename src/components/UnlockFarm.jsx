  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      if (currentRole === 'client') {
        ...
        const verifyUrl = `/fetch_farm/partner?mobile_no=${userMobileNumber}&farm_id=${farmId.trim()}`;
      ...
      // Construct API URL using proxy
      const apiUrl = `/internal/premium?farm_id=${farmId.trim()}&lockstatus=${lockStatus}&mode=${paymentMode}&expiry=${expiryValue}`;
      
      console.log('Calling unlock API:', apiUrl);
      ...
      <div className="topbar" style={{marginBottom: '16px', marginLeft: '0', marginRight: '0', backgroundColor: '#ffffff', borderBottom: '1px solid var(--border)', padding: '0 24px'}}>
        <div className="tb-left">
          <div>
            ...
            <div className="tb-sub">Operations · Access Control</div>
          </div>
        </div>
