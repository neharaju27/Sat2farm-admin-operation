...
export default function AddAcreages({ user, onPageChange }) {
  ...
  return (
    <div className="h-full text-slate-800 overflow-auto" style={{backgroundColor: '#f8f7f4'}}>
      ...
      <div className="topbar" style={{marginBottom: '16px', marginLeft: '0', marginRight: '0', backgroundColor: '#ffffff', borderBottom: '1px solid var(--border)', padding: '0 24px'}}>
        <div className="tb-left">
          <div>
            <div className="tb-page">Add Acreages</div>
            <div className="tb-sub">Operations · Acreage Management</div>
          </div>
        </div>
