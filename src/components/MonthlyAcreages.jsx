          ...
          {currentView === 'ops-acreage' && (
            <div className="view active">
              <div className="metrics">
                {mockData.monthlyAcreage.metrics.map((metric, index) => (
              ...
              <div className="two-col" style={{marginBottom: '16px'}}>
                <div className="card">
                  ...
                  <div className="card-body">
                    {mockData.monthlyAcreage.cropData.map((crop, index) => (
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="stat-list">
                      {mockData.monthlyAcreage.stateData.map((state, index) => (
              ...
              <div className="card">
                ...
                <div className="tbl-wrap">
                  <table>
                    ...
                    <tbody>
                      {mockData.monthlyAcreage.clients.map((client, index) => (
                        <tr key={index}>
                          <td>
